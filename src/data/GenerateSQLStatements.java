...
public class GenerateSQLStatements extends MainClass {
  ...
  public static void createSQLInserts(File source, BufferedWriter buffer) throws IOException {
    ...
    // we remove content of table locations
    ...
    while ((line = br.readLine()) != null) {
      ...
      if (i != 0) {
        ...
        if (!value[6].contentEquals("null") && !value[7].contentEquals("null")) {
          // log.info("we will insert!!");
          buffer
              .append("INSERT INTO locations(name,type,address,district,postcode,city,latitude,longitude,description,website,phone,date,schedule,email,csvName,population,elevation,other,rating,nrating) VALUES(");
          j = 0;
